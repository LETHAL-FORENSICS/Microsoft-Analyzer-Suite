...
-- Description: Create a new Transport Rule in an organization (Suspicious Operation)
-- Id: b7ae628b-4569-4d7b-aeb9-12659f9aa82d
...
list_extract(list_filter(auditData.Parameters, lambda x: x.Name = 'FromScope'), 1).Value AS FromScope,
COALESCE(
